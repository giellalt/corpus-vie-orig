...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:variable name="filename" select="'http://www.udir.no/globalassets/upload/pp_tjenesten/ppt_vietnamesisk_faktaark.pdf'"/>
    ...
    <xsl:variable name="mainlang" select="'vie'"/>
	...
	<parallel_text xml:lang="urd" location="sfs_veiledning_1_ppt_urdu_faktaark.pdf"/></xsl:variable>
